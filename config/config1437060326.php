 ...
 */
$conf['settings']['app.title'] = 'Gracepoint SD RMS';			// application title
...
$conf['settings']['admin.email'] = 'richyen@gpmail.org';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Richard Yen';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['database']['password'] = 'Grac3RMS';
 ...
 */
$conf['settings']['install.password'] = 'Grac3RMS';
/**
 * Pages
 */
