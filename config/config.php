...
$conf['settings']['phpmailer']['smtp.username'] = 'richyen3@gmail.com';
$conf['settings']['phpmailer']['smtp.password'] = 'vxejrkbramfukebm';
...
$conf['settings']['new.user.group'] = 'gpsd';
?>